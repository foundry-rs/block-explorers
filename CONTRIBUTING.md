# Contributing to Foundry Block Explorers

:balloon: Thanks for your help improving the project! We are so happy to have
you!

There are opportunities to contribute to Foundry Block Explorers at any level. It doesn't
...
The Foundry Block Explorers project adheres to the [Rust Code of Conduct][coc]. This describes
...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in Foundry Block Explorers, creating a new issue in the Foundry Block Explorers
...
3. By helping to resolve the issue: Typically this is done either in the form of
   ...
   Foundry Block Explorers in a concrete and reviewable manner.
...
When opening a new issue in the Foundry Block Explorers issue tracker, users will be presented
...
cases should be limited, as much as possible, to using only Foundry Block Explorers APIs.
...
functional guidelines of the Foundry Block Explorers project.

## Pull Requests

Pull Requests are the way concrete changes are made to the code, documentation,
and dependencies in the Foundry Block Explorers repository.
...
Foundry Block Explorers maintains strict standards for code quality and style, as well as
...
example), it is either adding new functionality to Foundry Block Explorers or it is fixing
existing, broken functionality. In both of these cases, the pull request should
include one or more tests to ensure that Foundry Block Explorers does not regress in the
future.
...
**Any Foundry Block Explorers community member is welcome to review any pull request**.

All Foundry Block Explorers contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for Foundry Block Explorers?
2. Does this change make Foundry Block Explorers better, even if only incrementally?
...
Foundry Block Explorers Collaborator landing the Pull Request but they can also be an
...
a particular change that makes Foundry Block Explorers better, but the individual might just
not want to have anything to do with Foundry Block Explorers ever again. The goal is not just
having good code.
